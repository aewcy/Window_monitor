...
<template>
  <div class="card">
    ...
    <div class="card-body">
      <div v-for="r in records" :key="r.id" class="br-row">
...
.br-row { display: flex; align-items: center; gap: 10px; padding: 5px 16px; border-bottom: 1px solid rgba(255,255,255,.02); font-size: 12px; }
