...
<template>
  <div class="card">
    ...
    <div class="card-body">
      <div v-for="e in events" :key="e.id" class="tl-row">
...
.tl-row { display: flex; align-items: center; gap: 10px; padding: 6px 16px; border-bottom: 1px solid rgba(255,255,255,.02); font-size: 12px; }
