        ...
        Get-ChildItem -Path $root -ErrorAction SilentlyContinue | ForEach-Object {
            try {
                ...
                if ($item.DisplayName -eq $script:ProductName) {
                    Set-ItemProperty -LiteralPath $_.PSPath -Name "DisplayVersion" -Value "0.59.0" -ErrorAction Stop
                    ...
                    Write-InstallLog "Updated uninstall registry version=0.59.0 publisher=$script:ProductPublisher"
                }
            } catch {
